...
from app.engine.app_process import encode_process
from app.ui.fonts_properties import *

file_path = ""

def run_encode_ui(parent_window):
    # ----------------------
    # MAIN WINDOW SETUP
    # ----------------------
    encode_root = Toplevel(parent_window)
    ...
    encode_root.protocol("WM_DELETE_WINDOW", encode_root.destroy)
    encode_root.transient(parent_window)
    encode_root.grab_set()
    parent_window.wait_window(encode_root)